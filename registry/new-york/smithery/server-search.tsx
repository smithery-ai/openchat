...
async function checkConnectionStatus(
  ...
  try {
    const { transport } = await createConnection({ client, connectionId, namespace });
    ...
    if (error instanceof SmitheryAuthorizationError) {
      ...
      console.log("connection requires authorization", { connectionId, namespace, authorizationUrl });
      return {
