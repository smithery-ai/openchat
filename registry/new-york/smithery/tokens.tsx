            ...
            {sandboxMode ? (
              <div className="space-y-3 rounded-lg border border-amber-200 bg-amber-50 p-4">
                ...
                <div className="border-t border-amber-200 pt-3">
                  <span className="text-sm text-amber-900 font-medium mb-2 block">Persist Connections with a Smithery Account</span>
                  <p className="text-xs mb-2 text-amber-800">To save your work and use Smithery across devices, create a free account and switch to Persistent Mode by running:</p>
